...
class BotController extends EventEmitter {
  ...
  _registerHandlers() {
    ...
    // Avant, seul 'clientReady' était écouté — si l'environnement de prod
    // n'émettait que 'ready', le bot restait bloqué sur "connecting" pour
    // toujours (WebSocket bien connecté, mais le statut ne passait jamais
    // à "online"). Le flag évite d'exécuter la logique deux fois si les
