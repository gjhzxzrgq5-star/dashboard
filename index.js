...
<style>
  ...
  /* Style complémentaire pour le tableau des tickets */
  .tickets-table {
    width: 100%;
...
<div class="app">
  <aside class="sidebar">
    ...
    <div class="nav-item" data-view="fivembans">
      <svg class="icon-svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"/></svg>
      Bannis FiveM
    </div>
    <div class="nav-item" data-view="customization">
      <svg class="icon-svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a7 7 0 1 0 10 10"/></svg>
      Studio & Thèmes
    </div>
  ...
  <main class="main">
    ...
    <section class="view" id="view-connection">
      <div class="page-header">
        <h1>Connexion bot</h1>
        <p>Le token du bot Discord (Developer Portal → Bot → Reset Token).</p>
      </div>

      <div class="panel">
        <div class="field">
          <label for="input-token">Token du bot</label>
    ...
    <section class="view" id="view-general">
      ...
      <div class="panel">
        <h3 class="panel-title">Panel de tickets</h3>
        <p class="panel-sub">Le serveur et le salon où le message avec les boutons sera publié.</p>
        <div class="field-row">
          <div class="field">
      ...
      <div class="panel">
        <h3 class="panel-title">Serveur staff</h3>
        <p class="panel-sub">Le serveur (souvent privé) où les salons de tickets sont créés par défaut.</p>
        <div class="field-row">
          <div class="field">
      ...
      <div class="panel">
        <h3 class="panel-title">Configuration Serveur FiveM</h3>
        <p class="panel-sub">Paramétrez le lien de connexion directe de votre serveur FiveM pour lier l'application au Bot Discord.</p>

        <div class="field-row" style="align-items:center; margin-bottom: 20px;">
          <label for="toggle-fivem" style="margin:0; font-weight: bold;">Activer l'intégration FiveM</label>
          <input type="checkbox" id="toggle-fivem" style="width:auto;">
        </div>

        <div id="fivem-options-container">
          <fieldset style="border: 1px solid var(--border-color, #333); border-radius: 8px; padding: 15px; margin-bottom: 20px;">
            <legend style="padding: 0 8px; font-weight: bold; color: var(--primary-color, #5865F2);">🌐 Connexion FiveM</legend>
            <div class="field">
              <label for="input-fivem-url">Lien de connexion au serveur FiveM</label>
              <input type="url" id="input-fivem-url" class="mono" placeholder="https://cfx.re/join/xxxxxx ou cfx.re/join/xxxxxx">
            </div>
          </fieldset>

          <button class="btn-primary" id="save-fivem-btn" style="margin-top: 15px;">Enregistrer la config FiveM</button>
        </div>
      </div>

      <button class="btn-primary" id="save-general-btn" style="margin-top:20px;">Enregistrer la configuration générale</button>
    </section>

    <section class="view" id="view-customization">
      <div class="page-header">
        <h1>Studio & Thèmes</h1>
        <p>Gère l'apparence, l'effet de flou et les notifications de ton espace.</p>
      </div>
    ...
    <section class="view" id="view-fivembans">
      <div class="page-header">
        <h1>Bannis FiveM</h1>
        <p>Liste des joueurs bannis sur le serveur FiveM configuré.</p>
      </div>

      <div class="panel" id="fivembans-panel">
        <div class="toolbar-row">
          <div>
            <h3 class="panel-title" style="margin-bottom:0;">Liste des bannis</h3>
            <p class="panel-sub" id="fivembans-server-info" style="margin:4px 0 0;"></p>
          </div>
          <button class="btn-ghost" id="refresh-fivembans-btn">Actualiser</button>
        </div>
        <div id="fivembans-list"></div>
      </div>
    </section>
    ...
    <section class="view" id="view-changelog">
      ...
      <div class="panel">
        <div style="display: flex; justify-content: space-between; align-items: center;">
          <h3 class="panel-title">Version 2.4.0</h3>
        ...
        <ul class="changelog-list">
          ...
          <li><span class="changelog-tag tag-feat">Nouveau</span> Messages de bienvenue personnalisés avec variables dynamique (ex: <code>{user}</code>).</li>
  ...
  <div class="modal">
    ...
    <div class="field-row">
      <div class="field" style="max-width:90px;">
        ...
        <input type="text" id="type-emoji" maxlength="4" placeholder="🎫">
      </div>
      <div class="field">
